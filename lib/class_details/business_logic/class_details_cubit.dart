...
class ClassDetailsCubit extends Cubit<ClassDetailsState> {
  ...
  Future<void> addToAttendance(
      StudentsModel student, ClassModel currentClass) async {
  ...
  Future<void> updateHistory(ClassModel currentClass, String studentId,
  ...
  Future<void> addHistoryToAttendantStudent(ClassModel currentClass,
      String studentId, Map<String, dynamic> history) async {
